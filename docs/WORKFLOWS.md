...
4. If rotated slicing is needed, prefer `u1_compare_transformed_orientations`. It creates local transformed STL/3MF copies and slices those, avoiding Snapmaker Orca CLI rotation flags.
